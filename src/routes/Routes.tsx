        ...
        <Switch>
            <MainLayout>
                <Switch>
                    ...
                    <PrivateRoute exact path={Urls.jobs} component={Jobs} />
                    ...
                    <PrivateRoute exact path={Urls.articles.create} component={() => <NewArticle placeholder={"Start typing your article here..."}/> } />
                </Switch>
            </MainLayout>
        </Switch>
    </Switch>
